...
---
# **Find the number that appears once while all other numbers appear twice.**
...
# 3. Optimal Approach (XOR Method) ⭐ Most Important
...
Given an array where **every number appears twice except one number**, find the number that appears **only once**.
...
Check each element and count how many times it appears.
